...
void CSettings::LoadSettings(const char* szNickName, int iChatLines)
{
	...
	m_Settings.fButtonMicrophoneSize = ini_table_get_entry_as_float(config, "gui", "MicrophoneSize", 0.0f);
	m_Settings.fButtonMicrophoneX = ini_table_get_entry_as_float(config, "gui", "MicrophoneX", 0.0f);
	m_Settings.fButtonMicrophoneY = ini_table_get_entry_as_float(config, "gui", "MicrophoneY", 0.0f);
	...
	m_Settings.iFPS = ini_table_get_entry_as_int(config, "gui", "fps", 120);
