...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
    "Ket noi den SA-RP City...",
    "Dang ket noi. Vui long doi...",
    "Dang tai du lieu, vui long doi...",
    "{00CCFF}[SA-RP.NET]{FFFFFF} Chao mung den voi thanh pho SA-RP City!",
    "unused",
    "Ban khong the ket noi may chu. Kiem tra mang va thu lai.",
    "Dang ket noi den may chu, vui long doi mot chut...",
    "Dang ket noi den may chu, vui long doi mot chut...",
    "Da ket noi thanh cong. Chuan bi vao game..."
};
