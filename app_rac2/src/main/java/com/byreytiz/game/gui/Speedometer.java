...
public class Speedometer {
    ...
    public Speedometer(Activity activity){
        ...
        mBG = activity.findViewById(R.id.speedo_center);
        mSpeed = activity.findViewById(R.id.speed_text);
        mStrela = activity.findViewById(R.id.speedo_arrow);
        mStrela2 = activity.findViewById(R.id.speedo_arrow2);
    ...
    public void setTurnlight(int turnlight){
        switch (turnlight)
        {
            ...
            default: {
                deleteThreads();
                mBG.setImageResource(R.drawable.arrow);
                mStrela.setImageResource(R.drawable.arrow);
                mStrela2.setImageResource(R.drawable.arrow);
            }
        }
    }
            ...
            while(!Thread.currentThread().isInterrupted())
            {
                activity.runOnUiThread(() -> {
                    if(turnlight_all_state) {
                        mBG.setImageResource(R.drawable.speedo_blinker);
                        ...
                        mBG.setImageResource(R.drawable.speedo_ablinker);
