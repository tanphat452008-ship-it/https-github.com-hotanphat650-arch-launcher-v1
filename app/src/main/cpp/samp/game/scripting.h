...
const SCRIPT_COMMAND set_current_actor_weapon			= { 0x01B9, "ii" };	// actor handle, weapon
...
const SCRIPT_COMMAND set_car_engine_broken				= { 0x081D, "ii"}; // vehicle handle, state
...
const SCRIPT_COMMAND remove_car_component				= { 0x06E8, "iiv" };
...
const SCRIPT_COMMAND is_char_dead						= { 0x0118, "i" }; // actor handle
...
const SCRIPT_COMMAND is_char_holding_object				= { 0x0737, "ii" }; // actor handle, object handle
const SCRIPT_COMMAND camera_set_shake_simulation_simple	= { 0x099C, "iff" };
const SCRIPT_COMMAND task_pick_up_object				= { 0x070A, "iifffiissi" };
const SCRIPT_COMMAND set_gamespeed						= { 0x015D, "i" };
const SCRIPT_COMMAND set_actor_dicision					= { 0x060B, "ii" };
const SCRIPT_COMMAND is_object_attached					= { 0x0685, "i" }; // object handle
