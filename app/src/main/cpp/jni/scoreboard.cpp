...
void CScoreBoard::Draw()
{
    ...
    sprintf(szServerAddress, "%s | SA-RP Member : %d", serverUTF8.c_str(), m_pPlayerCount);
    ...
    ImGui::Text("Ten nhan vat"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 50); ImGui::NextColumn();
    ImGui::Text("Cap do"); ImGui::SetColumnWidth(-1, m_fScoreBoardSizeX / 100 * 25); ImGui::NextColumn();
